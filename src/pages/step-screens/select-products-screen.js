...
export default function StepTwoScreen({
  ...
  const handlePriceChange = event => {
    isPriceChangeEnabled && setProductAttribute({ price: event.target.value });
  };
  ...
  let buttonEnabled =
    product !== null && description !== "" && quantity !== null && price !== null && isEditDisabled === false;
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                id="Descripcion"
                value={description}
                onChange={event => setProductAttribute({ description: event.target.value })}
              />
            </Grid>
            <Grid item xs={3}>
              <TextField
                ...
                value={quantity}
                numericFormat
                onChange={event => setProductAttribute({ quantity: event.target.value })}
              />
            </Grid>
            <Grid item xs={6}>
              <TextField
