...
import { validateCustomerIdentifier, setCustomer, setCustomerAttribute, saveCustomer } from "store/customer/actions";
    ...
    <div className={classes.root}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={5} sm={3} md={2}>
          <Button disabled={disabled} label="Guardar" onClick={() => saveCustomer()} />
        </Grid>
        <Grid item xs={5} sm={3} md={2}>
