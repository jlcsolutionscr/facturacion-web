...
function MobileAppPage() {
  ...
  return (
    <div id='id_mobile_app_page' className={classes.container}>
      ...
      <Accordion classes={{root: classes.expantionPanel}} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary
        ...
        <AccordionDetails style={{display: 'block'}}>
          ...
          <Grid container spacing={2} justifyContent='space-around'>
            <Grid item xs={12} md={6}>
              <img src={FirstSignInStepImage} className={classes.twoImages} alt='not available' />
            </Grid>
            <Grid item xs={12} md={6}>
              <img src={SecondSignInStepImage} className={classes.twoImages} alt='not available' />
            </Grid>
          </Grid>
        </AccordionDetails>
      </Accordion>
      <Accordion classes={{root: classes.expantionPanel}} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary
          classes={{expandIcon: classes.expantionIcon}}
          expandIcon={<ExpandMoreIcon />}
          aria-controls='panel1a-content'
        ...
        <AccordionDetails style={{display: 'block'}}>
          ...
          <Grid container spacing={2} justifyContent='space-around'>
            <Grid item xs={12} md={6}>
              <img src={LoginImage} className={classes.twoImages} alt='not available' />
            </Grid>
            <Grid item xs={12} md={6}>
              <img src={MenuImage} className={classes.twoImages} alt='not available' />
            </Grid>
          </Grid>
        </AccordionDetails>
      </Accordion>
      <Accordion classes={{root: classes.expantionPanel}} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary
          classes={{expandIcon: classes.expantionIcon}}
          expandIcon={<ExpandMoreIcon />}
          aria-controls='panel1a-content'
        ...
        <AccordionDetails style={{display: 'block'}}>
          ...
          <Grid container spacing={2} justifyContent='space-around'>
            <Grid item xs={12} md={4}>
              <img src={FirstInvoiceStepImage} className={classes.threeImages} alt='not available' />
            </Grid>
            <Grid item xs={12} md={4}>
              <img src={SecondInvoiceStepImage} className={classes.threeImages} alt='not available' />
            </Grid>
            <Grid item xs={12} md={4}>
              <img src={ThirdInvoiceStepImage} className={classes.threeImages} alt='not available' />
            </Grid>
          </Grid>
        </AccordionDetails>
      </Accordion>
      <Accordion classes={{root: classes.expantionPanel}} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        <AccordionSummary
          classes={{expandIcon: classes.expantionIcon}}
          expandIcon={<ExpandMoreIcon />}
          aria-controls='panel1a-content'
        ...
        <AccordionDetails style={{display: 'block'}}>
          ...
          <Grid container spacing={2} justifyContent='space-around'>
            <Grid item xs={12} md={12}>
              <img src={InvoiceListImage} className={classes.oneImage} alt='not available' />
            </Grid>
          </Grid>
        </AccordionDetails>
      </Accordion>
      <Accordion classes={{root: classes.expantionPanel}} expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
        <AccordionSummary
          classes={{expandIcon: classes.expantionIcon}}
          expandIcon={<ExpandMoreIcon />}
          aria-controls='panel1a-content'
        ...
        <AccordionDetails style={{display: 'block'}}>
          ...
          <Grid container spacing={2} justifyContent='space-around'>
            <Grid item xs={12} md={4}>
              <img src={FirstDocumentStepImage} className={classes.threeImages} alt='not available' />
            </Grid>
            <Grid item xs={12} md={4}>
              <img src={SecondDocumentStepImage} className={classes.threeImages} alt='not available' />
            </Grid>
            <Grid item xs={12} md={4}>
              <img src={ThirdDocumentStepImage} className={classes.threeImages} alt='not available' />
            </Grid>
          </Grid>
        </AccordionDetails>
      </Accordion>
      <Accordion classes={{root: classes.expantionPanel}} expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
        <AccordionSummary
          classes={{expandIcon: classes.expantionIcon}}
          expandIcon={<ExpandMoreIcon />}
          aria-controls='panel1a-content'
        ...
        <AccordionDetails style={{display: 'block'}}>
          ...
          <Grid container spacing={2} justifyContent='space-around'>
            <Grid item xs={12} md={12}>
              <img src={ReportGenerationImage} className={classes.oneImage} alt='not available' />
            </Grid>
          </Grid>
        </AccordionDetails>
      </Accordion>
