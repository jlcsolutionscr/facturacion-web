    ...
    <div id='id_mobile_app_page' className={classes.root}>
      ...
      <ExpansionPanel classes={{root: classes.expantionPanel}} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <ExpansionPanelSummary
          ...
          id="panel1a-header"
        >
          <Typography className={classes.subTitle}>Registre su dispositivo</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails style={{display: 'block'}}>
          ...
          <div style={{marginTop: '2%', width: '100%'}}>
            <img src={FirstSignInStepImage} style={{marginLeft: '22.5%', width: '25%'}} />
            <img src={SecondSignInStepImage} style={{marginLeft: '5%', width: '25%'}} />
          </div>
      ...
      <ExpansionPanel classes={{root: classes.expantionPanel}} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        ...
        <ExpansionPanelDetails style={{display: 'block'}}>
          ...
          <div style={{marginTop: '2%', width: '100%'}}>
            <img src={LoginImage} style={{marginLeft: '22.5%', width: '25%'}} />
            <img src={MenuImage} style={{marginLeft: '5%', width: '25%'}} />
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel classes={{root: classes.expantionPanel}} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        ...
        <ExpansionPanelDetails style={{display: 'block'}}>
          ...
          <div style={{marginTop: '2%', width: '100%'}}>
            <img src={FirstInvoiceStepImage} style={{marginLeft: '5%', width: '25%'}} />
            <img src={SecondInvoiceStepImage} style={{marginLeft: '5%', width: '25%'}} />
            <img src={ThirdInvoiceStepImage} style={{marginLeft: '5%', width: '25%'}} />
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel classes={{root: classes.expantionPanel}} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        ...
        <ExpansionPanelDetails style={{display: 'block'}}>
          ...
          <div style={{marginTop: '2%', textAlign: 'center', width: '100%'}}>
            <img src={InvoiceListImage} style={{width: '25%'}} />
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel classes={{root: classes.expantionPanel}} expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
        ...
        <ExpansionPanelDetails style={{display: 'block'}}>
          ...
          <div style={{marginTop: '2%', width: '100%'}}>
            <img src={FirstDocumentStepImage} style={{marginLeft: '5%', width: '25%'}} />
            <img src={SecondDocumentStepImage} style={{marginLeft: '5%', width: '25%'}} />
            <img src={ThirdDocumentStepImage} style={{marginLeft: '5%', width: '25%'}} />
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel classes={{root: classes.expantionPanel}} expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
        ...
        <ExpansionPanelDetails style={{display: 'block'}}>
          ...
          <div style={{marginTop: '2%', textAlign: 'center', width: '100%'}}>
            <img src={ReportGenerationImage} style={{width: '25%'}} />
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
    </div>
